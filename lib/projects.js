...
import WasteTracking from '@/lib/img/waste-ai-thumb.png';
...
const projects = [
    {
        ...
        image: WasteTracking,
        description: ["AI-powered tool that automates hazardous waste manifest processing for industrial facilities. The feature uses a fine-tuned GPT-4o model to extract structured data from scanned or photographed manifests, eliminating manual entry and enabling real-time compliance tracking. This was the first AI feature in the environmental compliance space of its kind, and it has already seen rapid adoption among Mapistry customers."],
        links: [
            {
                id: 1,
            ...
            },
            {
                ...
                url: "https://www.mapistry.com/mapistry-blog-2025/how-mapistry-is-automating-hazardous-waste-tracking-with-ai",
            },
            {
                id: 4,
